...
from gui import show_settings_dialog  # Import funkcji wyświetlającej ustawienia
...
def setup_tray(root):
    menu = Menu(
        ...
        MenuItem('Reset to Default', lambda: root.after(0, lambda: reset_to_default(load_config()))),  # Załaduj konfigurację i zresetuj ustawienia z potwierdzeniem
